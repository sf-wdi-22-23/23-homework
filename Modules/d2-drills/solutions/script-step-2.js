...
// We'll give you the first one because it is highly unlikely you will figure it out unless you have prior experience 
// with the .datepicker()
// You need to call datepicker's 'getDate' method (this is an example of closure) ...and then you have to call the 
// Date() object's .getTime(); method on the whole thing:
